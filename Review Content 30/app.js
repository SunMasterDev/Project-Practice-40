...
function showReview(){
    const {name,job,text,image} = userdata[activeIndex] //ชื่อ property ตรงกัน
    review.innerHTML=text;
    userImg.src=image; //รูป src
...
setInterval(showReview,10000); //กำหนดช่วงเวลา เปลี่ยนรีวิว 10000 ms